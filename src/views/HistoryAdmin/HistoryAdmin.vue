<template>
  <div class="containPage" v-if="isLogin">
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="search">
        <input class="inputSearch" v-model="searchQuery" type="search" placeholder="Tìm kiếm đọc giả"
          aria-label="Search" />
        <span @click="searchDocGia" class="iconSearch"><i class="fa-solid fa-magnifying-glass"></i></span>
      </div>
    </div>
    <div class="contentPage" :style="`${isLogin ? '' : 'display: none'}`">
      <div class="list-group">
        ...
        <div v-for="(rented, index) in dataRented" :key="rented._id"
          ...
          <div class="infoUser mb-2">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <p class="m-0 font-weight-bold" style="color: #40c1fa; font-size: 1.4rem">
                ...
                <a-dropdown class="ml-auto">
                  ...
                  <template #overlay>
                    <a-menu>
                      <a-menu-item>
                        <a @click="showModal(rented)"><i class="fa-solid fa-pen" style="color: blue"></i></a>
                      </a-menu-item>
                      <a-menu-item>
                        <a @click="showModalDelete(rented)"><i class="fa-solid fa-trash" style="color: red"></i></a>
                      </a-menu-item>
                    </a-menu>
                  </template>
                </a-dropdown>
          ...
          <div class="d-flex">
            ...
            <a-modal style="top: 40px" v-model:open="isModalDelete" title="Xóa đơn mượn" @ok="handleOkDelete()"
              :ok-button-props="okButtonProps" @cancel="handleCancelDelete" cancelText="Đóng" okText="Xóa đơn mượn">
              <p>Bạn có chắc muốn xóa đơn mượn.</p>
            </a-modal>
            <a-modal style="top: 40px" v-model:open="isModal" width="500px" title="Cập nhật trạng thái mượn"
              @ok="handleOkUpdateTraSach" @cancel="handleCancelUpdate" :ok-button-props="okButtonAccess"
              cancelText="Đóng" okText="Xác nhận">
          ...
          <div class="d-flex">
            <div>
              <p>
                Thành tiền:
                <span style="color: #d50d0d; font-weight: bold">{{ rented.ThanhTien }} VND</span>
              </p>
              <p class="d-inline">
            ...
            <div v-if="rented.TrangThai === 'A'" class="statusOrderSuccess mr-0 mb-0">
              Đã duyệt
            </div>
